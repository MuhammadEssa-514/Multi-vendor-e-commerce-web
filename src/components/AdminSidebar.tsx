            ...
            <div className="p-6 border-b border-slate-800 flex items-center justify-between h-16">
                <div className="flex items-center gap-3 group">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-[8px] font-bold text-slate-400 uppercase tracking-widest leading-none mt-1 group-hover:text-blue-400 transition-colors">Administrator</span>
                    </div>
                </div>
                {onNavigate && (
